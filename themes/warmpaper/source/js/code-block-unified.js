...
(function() {
  ...
  function initMermaid() {
    ...
    if (!fontFamily) fontFamily = '"trebuchet ms",verdana,arial,sans-serif';
    ...
    function renderTheme(dark, cb) {
      ...
      mermaid.initialize({ startOnLoad: false, theme: theme, securityLevel: "loose", fontFamily: fontFamily });
